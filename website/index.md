...
The overarching goal of this project is to create an easy-to-implement tool that can predict future migration routes of any animal with historic tracking data using an automated machine learning process. 
